...
variable "default_node_service_account_id" {
...
variable "default_version_k8s_masters" {
  default = "<your version of k8s masters>"
}

variable "default_version_k8s_node_group" {
  default = "<your version of k8s node-group>"
}

variable "default_release_channel" {
  default = "STABLE"
}